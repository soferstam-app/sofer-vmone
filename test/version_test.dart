...
void main() {
  ...
  test('the build number is not left behind', () {
    // Play refuses an upload whose versionCode has not increased, and the
    // refusal comes at the end of a long upload rather than here.
    expect(declaredInPubspec().code, greaterThan(1),
        reason: '0.3.0 shipped as build 1');
  });
}

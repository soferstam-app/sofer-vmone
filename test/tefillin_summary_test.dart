...
// שמע של ראש, והיה אם שמוע של ראש" but "תפילין של ראש". The arithmetic that
...
void main() {
  ...
  group('what was recorded whole is said whole', () {
    ...
    test('a head on its own', () {
      expect(describe([session(type: 'head', amount: 2)]),
          '2 תפילין של ראש');
    });
  ...
  group('loose parshiyot are gathered up', () {
    ...
    test('four and four make a pair, not two halves', () {
      ...
      expect(describe([...allFour('head'), ...allFour('hand')]),
          'זוג תפילין אחד');
    });
  ...
  group('the parshiyot are named in order', () {
    test('one to four', () {
      ...
      expect(TefillinSummary.parshiyaName(4), 'והיה אם שמוע');
    });

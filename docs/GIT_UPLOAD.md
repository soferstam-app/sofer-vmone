...
- ~~**תמונה ללא שימוש**: `docs/unnamed.jpg`~~ — **טעות: היא בשימוש.** `docs/index.html` בנוי עליה כרקע. היא הועלתה ידנית דרך הדפדפן כי היא הייתה ב-`.gitignore`, וכעת היא במעקב כרגיל.

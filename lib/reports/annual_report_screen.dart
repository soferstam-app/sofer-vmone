...
class _AnnualReportScreenState extends State<AnnualReportScreen> {
  ...
  Future<void> _load() async {
    ...
    // The engine has taken payments since they were introduced; this screen
    // never handed them over, so a year of recorded payments reported an
    // income of zero to the writer's accountant.
    final payments = await _storage.loadPayments();
                ...
                child: ListView(
                  children: [
                    ...
                    Padding(
                      ...
                      child: Text(
                        'הכנסות הן הכסף שהתקבל בפועל — התשלומים שנרשמו, '
                        'לפי מועד קבלתם. שווי העבודה שנכתבה השנה הוא מספר '
                        'אחר, והוא אינו הכנסה עד שהוא משולם. הוצאות הן חומרי '
                        'הגלם ליחידה, ההוצאות שנרשמו ועלות ההגהה. עבודה '
                        'שסומנה כהשלמת עבר אינה נספרת.',
                        style: TextStyle(
                            fontFamily: t.labelFamily,
                            fontSize: 11,
                            height: 1.7,

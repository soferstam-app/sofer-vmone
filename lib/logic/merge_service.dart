...
class MergeService {
  ...
  static MergeOutcome mergeBackup({
    ...
    List<Payment> localPayments = const [],
    List<Payment> incomingPayments = const [],
  }) {
    ...
    final y = mergeById<Payment>(localPayments, incomingPayments);
